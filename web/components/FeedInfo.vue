<template>
  <div>
    ...
    <a href="https://sofa.2fifteen.io/v1/macos_data_feed.json" target="_blank" rel="noopener noreferrer">View macOS Data Feed JSON</a>
    <div v-if="timestampData">
      ...
      <div>
        <h2>iOS feed file</h2>
        <a href="https://sofa.2fifteen.io/v1/ios_data_feed.json" target="_blank" rel="noopener noreferrer">View iOS Data Feed JSON</a>
